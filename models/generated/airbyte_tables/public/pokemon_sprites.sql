...
-- sprites at pokemon/sprites
where 1 = 1
),  __dbt__cte__pokemon_sprites_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_sprites_ab3
select
    _airbyte_pokemon_hashid,
    back_shiny_female,
    back_female,
...
from __dbt__cte__pokemon_sprites_ab3
-- sprites at pokemon/sprites from "postgres".public."pokemon"
where 1 = 1