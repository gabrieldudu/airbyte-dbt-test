...
-- abilities at pokemon/abilities
where 1 = 1
),  __dbt__cte__pokemon_abilities_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_abilities_ab3
select
    _airbyte_pokemon_hashid,
    is_hidden,
    slot,
...
from __dbt__cte__pokemon_abilities_ab3
-- abilities at pokemon/abilities from "postgres".public."pokemon"
where 1 = 1