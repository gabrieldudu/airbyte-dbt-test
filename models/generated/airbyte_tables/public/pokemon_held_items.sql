...
-- held_items at pokemon/held_items
where 1 = 1
),  __dbt__cte__pokemon_held_items_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_held_items_ab3
select
    _airbyte_pokemon_hashid,
    item,
    version_details,
...
from __dbt__cte__pokemon_held_items_ab3
-- held_items at pokemon/held_items from "postgres".public."pokemon"
where 1 = 1