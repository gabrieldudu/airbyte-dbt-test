...
-- forms at pokemon/forms
where 1 = 1
),  __dbt__cte__pokemon_forms_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_forms_ab3
select
    _airbyte_pokemon_hashid,
    "name",
    url,
...
from __dbt__cte__pokemon_forms_ab3
-- forms at pokemon/forms from "postgres".public."pokemon"
where 1 = 1