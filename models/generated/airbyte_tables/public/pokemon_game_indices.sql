...
-- game_indices at pokemon/game_indices
where 1 = 1
),  __dbt__cte__pokemon_game_indices_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_game_indices_ab3
select
    _airbyte_pokemon_hashid,
    game_index,
    "version",
...
from __dbt__cte__pokemon_game_indices_ab3
-- game_indices at pokemon/game_indices from "postgres".public."pokemon"
where 1 = 1