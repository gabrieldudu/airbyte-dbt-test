...
-- moves at pokemon/moves
where 1 = 1
),  __dbt__cte__pokemon_moves_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_moves_ab3
select
    _airbyte_pokemon_hashid,
    version_group_details,
    "move",
...
from __dbt__cte__pokemon_moves_ab3
-- moves at pokemon/moves from "postgres".public."pokemon"
where 1 = 1