...
-- item at pokemon/held_items/item
where 1 = 1
),  __dbt__cte__pokemon_held_items_item_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_held_items_item_ab3
select
    _airbyte_held_items_hashid,
    "name",
    url,
...
from __dbt__cte__pokemon_held_items_item_ab3
-- item at pokemon/held_items/item from "postgres".public."pokemon_held_items"
where 1 = 1