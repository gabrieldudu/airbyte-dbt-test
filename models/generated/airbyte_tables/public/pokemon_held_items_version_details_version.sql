...
-- version at pokemon/held_items/version_details/version
where 1 = 1
),  __dbt__cte__pokemon_held_items_version_details_version_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_held_items_version_details_version_ab3
select
    _airbyte_version_details_hashid,
    "name",
    url,
...
from __dbt__cte__pokemon_held_items_version_details_version_ab3
-- version at pokemon/held_items/version_details/version from "postgres".public."pokemon_held_items_version_details"
where 1 = 1