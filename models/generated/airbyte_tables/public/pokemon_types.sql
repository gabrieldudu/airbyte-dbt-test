...
-- types at pokemon/types
where 1 = 1
),  __dbt__cte__pokemon_types_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_types_ab3
select
    _airbyte_pokemon_hashid,
    slot,
    "type",
...
from __dbt__cte__pokemon_types_ab3
-- types at pokemon/types from "postgres".public."pokemon"
where 1 = 1