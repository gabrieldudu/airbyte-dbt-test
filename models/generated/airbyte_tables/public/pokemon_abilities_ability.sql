...
-- ability at pokemon/abilities/ability
where 1 = 1
),  __dbt__cte__pokemon_abilities_ability_ab3 as (
...
-- depends_on: __dbt__cte__pokemon_abilities_ability_ab3
select
    _airbyte_abilities_hashid,
    "name",
    url,
...
from __dbt__cte__pokemon_abilities_ability_ab3
-- ability at pokemon/abilities/ability from "postgres".public."pokemon_abilities"
where 1 = 1